...
```html
<div
  class="hero-block on-dark readable-width"
  style="--hero-bg-image: url('...');"
>
...
<div class="dark-background-block on-dark readable-width">
  <p>
    This line of text will not stretch across the entire screen, making it much
    easier to read.
  </p>
</div>
```
...
<div class="promoBox">
  <div class="blue-background-block on-dark hover-lift">
    <p>
      This blue box will lift on hover, even though it is inside another
      container.
    </p>
  </div>
</div>
...
Use the .alert-link class on an <a> tag only when it is inside an .on-dark container to create a high-contrast link. It will appear light-blue/white underlined. Class .alert-link on white background (without the background-block on-dark will look like a "professional blue" with no underlining
...
<div class="blue-gradient-block on-dark">
  <div class="p-3">
    ...
    <p>
      We offer professional printing services for businesses of all sizes. This
      is a <a href="#">regular link</a> and this is an
      <a href="#" class="alert-link">alert link</a> for primary actions.
    </p>
  </div>
</div>
```
...
<div class="blue-gradient-block-vertical on-dark">
  ...
  <p>
    Perfect for sidebars. <a href="#">Learn more</a> or
    <a href="#" class="alert-link">get started now</a>.
  </p>
</div>
```
...
<div class="dark-gradient-block on-dark">
  ...
  <p>
    Exclusive content for professional members.
    <a href="#" class="alert-link">Upgrade to Premium</a> or
    <a href="#">learn about benefits</a>.
  </p>
</div>
```
...
<div class="professional-gradient-block on-dark">
  <h4>Did You Know?</h4>
  <p>
    Our design team offers free file setup assistance.
...
<div class="blue-gradient-block on-dark text-center p-4">
  ...
  <p class="mb-3">
    Join thousands of satisfied customers who trust ColorCopiesUSA for
    professional printing services. We offer fast turnaround, competitive
    pricing, and exceptional quality.
  </p>
  <p>
    <a href="#" class="alert-link">Get Your Free Quote Now</a> or
    <a href="#">browse our product catalog</a>.
  </p>
</div>
```
...
<article class="card">
  <div class="card-body">
    ...
    <p>
      Save time and ensure your files are print-ready with our professionally
      designed templates. Available for all common sizes in multiple formats.
    </p>
    <p class="mb-0">
      <a href="#" class="alert-link">Download Templates</a> or
      <a href="#">watch the setup video</a>.
    </p>
  </div>
</article>
```
